...
namespace ContosoUniversity.common
{
    ...
    {
        static string appkey = "ba3e7a4c95200fb013a30787cfbe1139"; //配置您申请的appkey

        public static Weather GetWeatByCityName(string city)
        {
            ...
            parameters1.Add("dtype", "josn"); //返回数据格式：json或xml,默认json
